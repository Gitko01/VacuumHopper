...
public class VacuumHopperScreen extends HandledScreen<VacuumHopperScreenHandler> {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        if (redstoneModeButton != null) {
            redstoneModeButton.setTooltip(Tooltip.of(Text.translatable("gui." + VacuumHopper.MOD_ID + ".vacuum_hopper.redstoneMode." + redstoneMode)));
        }
        if (pushModeButton != null) {
            pushModeButton.setTooltip(Tooltip.of(Text.translatable("gui." + VacuumHopper.MOD_ID + ".vacuum_hopper.pushMode." + pushMode)));
        }
    }
    ...
    protected void init() {
        ...
        if (redstoneModeButton == null && redstoneMode != -1) {
            ...
            redstoneModeButton = this.addDrawableChild(createRedstoneModeWidget(
                    x, y, 8, 20, 16, 16, u, v, 0, TEXTURE, 256, 256, ButtonWidget::onPress, Tooltip.of(Text.translatable("gui." + VacuumHopper.MOD_ID + ".vacuum_hopper.redstoneMode." + redstoneMode)), Text.literal(""), client));
        }
        ...
        if (pushModeButton == null && pushMode != -1) {
            ...
            pushModeButton = this.addDrawableChild(createPushModeWidget(
                    x, y, 8, 39, 32, 16, u, v, 0, TEXTURE, 256, 256, ButtonWidget::onPress, Tooltip.of(Text.translatable("gui." + VacuumHopper.MOD_ID + ".vacuum_hopper.pushMode." + pushMode)), Text.literal(""), client));
        }
