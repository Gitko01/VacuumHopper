...
public class UpdateVacuumHopperRedstoneModePacket {
    private static final Identifier UPDATE_VACUUM_HOPPER_REDSTONE_MODE_PACKET_ID = new Identifier(VacuumHopper.MOD_ID, "update_vacuum_hopper_redstone_mode_packet");
